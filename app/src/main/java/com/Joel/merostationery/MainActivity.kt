...
import com.Joel.merostationery.Repository.UserRepo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        register.setOnClickListener(){
            ...
            if(password!=repeatPassword)
            {
                ...
                val user = Register(fname =Name,lname=lastName,address=address,phone=phone,username=username,password=password,type = "Customer")
